...
|------|----|-----|-----|-----|-------------|
| フレイモックス | 12 | 7 | 3 | 4 | 初撃の灼熱（first_attack_amp +2） |
| アクアリス | 16 | 4 | 5 | 4 | 清水の加護（turn_start_heal +1） |
| ゴーレム | 20 | 5 | 7 | 2 | 岩鎧（damage_reduction -1） |
| フェンリル | 10 | 5 | 3 | 8 | 疾風の祝福（spd_roll_bonus +2） |
| ヴォルタンク | 14 | 6 | 6 | 3 | 電磁シールド（1/6でダメージ無効） |
| ウンブラ | 12 | 6 | 4 | 5 | 影討ち（初撃がtrue_damage） |
| ルミベル | 14 | 5 | 5 | 5 | 光の選択（battle_start, ATK/DEFの高い方を+2） |
| ウロボロス | 10 | 3 | 4 | 6 | 時の積層（atk_per_active +1：攻撃ごとにATK+1） |
| ドラキュラ | 8 | 6 | 3 | 5 | 吸血（与ダメージの1/2を回復） |
