...
export const ACTIONS: ActionCard[] = [
  ...
  { id: 'ac-atk2hp',  name: '根性注入',   effect: { kind: 'trade_stat', from: 'atk', to: 'hp',  fromAmount: 2, toAmount: 18 }, count: 1 },
  ...
  { id: 'ac-def2hp',  name: '硬化訓練',   effect: { kind: 'trade_stat', from: 'def', to: 'hp',  fromAmount: 2, toAmount: 18 }, count: 1 },
  ...
  { id: 'ac-spd2hp',  name: '持久鍛錬',   effect: { kind: 'trade_stat', from: 'spd', to: 'hp',  fromAmount: 2, toAmount: 18 }, count: 1 },
