...
export const EVENTS: EventCard[] = [
  ...
  { id: 'ev-l03', name: '弱者の足枷',   target: 'lowestHp',   effect: { kind: 'stat_mod', stat: 'atk', amount: -2 } },
  { id: 'ev-l04', name: '弱者の重荷',   target: 'lowestHp',   effect: { kind: 'stat_mod', stat: 'def', amount: -2 } },
  { id: 'ev-l05', name: '弱者の縛り',   target: 'lowestHp',   effect: { kind: 'stat_mod', stat: 'spd', amount: -2 } },
  // ── highest stat (8種) ──────────────────────────────────────────────────────
