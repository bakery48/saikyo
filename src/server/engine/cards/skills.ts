...
export const SKILLS: SkillCard[] = [
  ...
  { id: 'sk-r-022', name: '危険な取引', rarity: 'R', nameTag: 'デンジャラス', active: { effect: { kind: 'pay_hp_debuff_all', hpCost: 4, amount: 1 } } },
  ...
  { id: 'sk-sr-053', name: '大物狩り', rarity: 'SR', nameTag: 'ジャイアント', active: { effect: { kind: 'conditional_attack_if_target_higher', stat: 'atk', multIf: 1.8, multElse: 1.0, useStat: 'atk', attackKind: 'passthrough' } } },
  ...
  { id: 'sk-sr-007', name: '鋼鉄の肉体', rarity: 'SR', nameTag: 'アイアン', active: { effect: { kind: 'buff_self', stat: 'def', amount: 6, duration: 'battle' } } },
