...
export const SKILLS: SkillCard[] = [
  ...
  { id: 'sk-r-020', name: '反射シールド', rarity: 'R', nameTag: 'リフレクター', active: { effect: { kind: 'share_damage_next', percent: 50 } } },
  ...
  { id: 'sk-ssr-003', name: '神盾', rarity: 'SSR', nameTag: 'セレスチャル', active: { effect: { kind: 'shield', amount: 12 } } },
