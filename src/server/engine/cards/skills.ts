...
export const SKILLS: SkillCard[] = [
  ...
  // ─── 相手ステータス参照（カウンターメタ） ──────────────────────────────────
  { id: 'sk-r-063', name: '剣返し', rarity: 'R', nameTag: 'カウンターブレード', active: { effect: { kind: 'target_stat_damage', stat: 'atk', mult: 1.2 } } },
  { id: 'sk-r-064', name: '盾返し', rarity: 'R', nameTag: 'カウンターシールド', active: { effect: { kind: 'target_stat_damage', stat: 'def', mult: 1.2 } } },
  { id: 'sk-r-068', name: '疾風返し', rarity: 'R', nameTag: 'カウンターゲイル', active: { effect: { kind: 'target_stat_damage', stat: 'spd', mult: 1.2 } } },
  ...
  { id: 'sk-sr-051', name: '剛剣返し', rarity: 'SR', nameTag: 'レイジングブレード', active: { effect: { kind: 'target_stat_damage', stat: 'atk', mult: 1.5 } } },
  { id: 'sk-sr-052', name: '剛盾返し', rarity: 'SR', nameTag: 'レイジングシールド', active: { effect: { kind: 'target_stat_damage', stat: 'def', mult: 1.5 } } },
  ...
  { id: 'sk-sr-054', name: '烈風返し', rarity: 'SR', nameTag: 'レイジングゲイル', active: { effect: { kind: 'target_stat_damage', stat: 'spd', mult: 1.5 } } },
  { id: 'sk-ssr-021', name: '覇盾返し', rarity: 'SSR', nameTag: 'オーバーシールド', active: { effect: { kind: 'target_stat_damage', stat: 'def', mult: 1.8 } } },
  { id: 'sk-ssr-024', name: '覇剣返し', rarity: 'SSR', nameTag: 'オーバーブレード', active: { effect: { kind: 'target_stat_damage', stat: 'atk', mult: 1.8 } } },
  ...
  },
  {
    ...
    passive: {
      trigger: { kind: 'on_take_damage' },
      effect: { kind: 'mid_damage_reduce', min: 4, max: 9, denominator: 2 },
    },
  },
  {
    id: 'sk-rp-036',
    ...
    passive: {
      trigger: { kind: 'on_take_damage' },
      effect: { kind: 'mid_damage_reduce', min: 4, max: 9, denominator: 4 },
    },
  },
  {
    id: 'sk-np-003',
    ...
    passive: {
      trigger: { kind: 'on_deal_damage' },
      effect: { kind: 'low_damage_bonus', threshold: 2, bonus: 1 },
    },
  },
  {
    id: 'sk-rp-038',
    ...
    passive: {
      trigger: { kind: 'on_deal_damage' },
      effect: { kind: 'low_damage_bonus', threshold: 2, bonus: 2 },
    },
  },
  {
    id: 'sk-rp-039',
    ...
    passive: {
      trigger: { kind: 'battle_start' },
      effect: { kind: 'low_hp_atk_mult', mult: 2, thresholdFraction: 1 / 3 },
    },
  },
  {
    id: 'sk-rp-040',
    ...
    passive: {
      trigger: { kind: 'battle_start' },
      effect: { kind: 'low_hp_atk_mult', mult: 2, thresholdFraction: 0.25 },
    },
  },
  {
    id: 'sk-rp-041',
    ...
    passive: {
      ...
      effect: { kind: 'grant_ghost_shield_on_last_active', amount: 10 },
    },
  },
  {
    id: 'sk-rp-042',
    ...
    passive: {
      trigger: { kind: 'on_last_active_used' },
      effect: { kind: 'grant_ghost_shield_on_last_active', amount: 20 },
    },
  },
  {
    id: 'sk-rp-023',
