...
export const SKILLS: SkillCard[] = [
  ...
  { id: 'sk-n-012', name: '構え', rarity: 'N', active: { effect: { kind: 'buff_self', stat: 'def', amount: 3, duration: 'once' } } },
  { id: 'sk-n-013', name: '威嚇', rarity: 'N', active: { effect: { kind: 'debuff_target', stat: 'atk', amount: 2, duration: 'battle' } } },
  { id: 'sk-n-014', name: '砂かけ', rarity: 'N', active: { effect: { kind: 'debuff_target', stat: 'def', amount: 2, duration: 'battle' } } },
  { id: 'sk-n-015', name: '叫び', rarity: 'N', active: { effect: { kind: 'debuff_target', stat: 'spd', amount: 2, duration: 'battle' } } },
  ...
  { id: 'sk-r-006', name: '岩石防御', rarity: 'R', nameTag: 'ロックアーマー', active: { effect: { kind: 'buff_self', stat: 'def', amount: 5, duration: 'once' } } },
  { id: 'sk-r-007', name: '加速装置', rarity: 'R', nameTag: 'ブースター', active: { effect: { kind: 'buff_self', stat: 'spd', amount: 4, duration: 'battle' } } },
  { id: 'sk-r-008', name: '威圧', rarity: 'R', nameTag: 'タイラント', active: { effect: { kind: 'debuff_target', stat: 'atk', amount: 4, duration: 'battle' } } },
  { id: 'sk-r-009', name: '装甲剥がし', rarity: 'R', nameTag: 'ブレイカー', active: { effect: { kind: 'debuff_target', stat: 'def', amount: 4, duration: 'battle' } } },
  { id: 'sk-r-010', name: '鈍化', rarity: 'R', nameTag: 'フリーザー', active: { effect: { kind: 'debuff_target', stat: 'spd', amount: 4, duration: 'battle' } } },
  ...
  { id: 'sk-r-017', name: '攻防一体', rarity: 'R', nameTag: 'バランス', active: { effect: { kind: 'buff_self', stat: 'def', amount: 4, duration: 'battle' } } },
  ...
  { id: 'sk-sr-006', name: '剛力解放', rarity: 'SR', nameTag: 'タイタン', active: { effect: { kind: 'buff_self', stat: 'atk', amount: 6, duration: 'battle' } } },
  { id: 'sk-sr-007', name: '鋼鉄化', rarity: 'SR', nameTag: 'スチール', active: { effect: { kind: 'buff_self', stat: 'def', amount: 6, duration: 'battle' } } },
  { id: 'sk-sr-008', name: '神速', rarity: 'SR', nameTag: 'ゴッドスピード', active: { effect: { kind: 'buff_self', stat: 'spd', amount: 6, duration: 'battle' } } },
  ...
  { id: 'sk-sr-012', name: '装甲粉砕', rarity: 'SR', nameTag: 'クラッシャー', active: { effect: { kind: 'debuff_target', stat: 'def', amount: 6, duration: 'battle' } } },
  { id: 'sk-sr-018', name: '時縛り', rarity: 'SR', nameTag: 'タイムストップ', active: { effect: { kind: 'debuff_target', stat: 'spd', amount: 6, duration: 'battle' } } },
  ...
  },
  {
    ...
    rarity: 'R',
    nameTag: 'フォーカス',
    active: { effect: { kind: 'buff_self', stat: 'atk', amount: 5, duration: 'once' } },
  },
  {
    id: 'sk-r-035',
    name: '陽炎',
