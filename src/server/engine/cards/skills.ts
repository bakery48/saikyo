...
export const SKILLS: SkillCard[] = [
  ...
  { id: 'sk-r-029', name: '闘気', rarity: 'R', nameTag: 'フォース', active: { effect: { kind: 'buff_self', stat: 'atk', amount: 2, duration: 'battle' } } },
  ...
  { id: 'sk-r-017', name: '攻防一体', rarity: 'R', nameTag: 'バランス', active: { effect: { kind: 'buff_self', stat: 'def', amount: 2, duration: 'battle' } } },
  ...
  { id: 'sk-sr-018', name: '時縛り', rarity: 'SR', nameTag: 'タイムストップ', active: { effect: { kind: 'debuff_target', stat: 'spd', amount: 3, duration: 'battle' } } },
  ...
  // ── R actives (new) ─────────────────────────────────────────────────────
  {
    ...
    rarity: 'R',
    nameTag: 'フリーズ',
    active: { effect: { kind: 'debuff_target', stat: 'spd', amount: 2, duration: 'battle' } },
  },
  {
    id: 'sk-r-029',
    name: '吸命術',
