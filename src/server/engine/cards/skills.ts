...
export const SKILLS: SkillCard[] = [
  ...
  { id: 'sk-n-016', name: '小傷', rarity: 'N', active: { effect: { kind: 'true_damage', amount: 5 } } },
  ...
  { id: 'sk-n-028', name: '影刺し', rarity: 'R', nameTag: 'シャドウ', active: { effect: { kind: 'true_damage', amount: 10 } } },

  // ─── R (Rare) ──────────────────────────────────────────────────────────────
  { id: 'sk-r-001', name: '強攻撃', rarity: 'R', nameTag: 'パワー', active: { effect: { kind: 'attack', mult: 1.3, useStat: 'atk', attackKind: 'passthrough' } } },
  { id: 'sk-r-002', name: '貫通刺突', rarity: 'SR', nameTag: 'ピアサー', active: { effect: { kind: 'true_damage', amount: 15 } } },
  ...
  { id: 'sk-r-060', name: '強欲の罪', rarity: 'N', nameTag: 'グリード', tag: 'sin', isPassive: true,
    passive: { trigger: { kind: 'on_own_active_used' }, effect: { kind: 'self_decay', hp: 0, atk: 1, def: 0, spd: 0 } } },
  { id: 'sk-r-061', name: '暴食の罪', rarity: 'N', nameTag: 'グラトニー', tag: 'sin', isPassive: true,
    passive: { trigger: { kind: 'battle_start' }, effect: { kind: 'stat_mod', stat: 'hp', amount: -8 } } },
  { id: 'sk-r-062', name: '色欲の罪', rarity: 'N', nameTag: 'ラスト', tag: 'sin', isPassive: true,
    passive: { trigger: { kind: 'on_take_damage' }, effect: { kind: 'damage_reduction', amount: -2 } } },
  ...
  // ─── SR (Super Rare) ───────────────────────────────────────────────────────
  { id: 'sk-sr-062', name: '覇気一閃', rarity: 'SR', nameTag: 'アサルト', active: { speedRush: true, effect: { kind: 'attack', mult: 2.0, useStat: 'atk', attackKind: 'passthrough' } } },
